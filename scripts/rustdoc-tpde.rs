...
fn main() {
    ...
    let cg_tpde_dylib_path = sysroot
        .join("lib")
        .join(env::consts::DLL_PREFIX.to_string() + "rustc_codegen_tpde" + env::consts::DLL_SUFFIX);
    ...
    if let Some(name) = option_env!("BUILTIN_BACKEND") {
        ...
        codegen_backend_arg.push(cg_tpde_dylib_path);
