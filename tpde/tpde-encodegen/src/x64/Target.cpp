...
void EncodingTargetX64::get_inst_candidates(
  ...
  handle_rm("SHRX32rr", "SHRX32rm", 1, "SHRX32rrr", "SHRX32rmr");
  handle_rm("SHRX64rr", "SHRX64rm", 1, "SHRX64rrr", "SHRX64rmr");
  handle_rm("SHLX32rr", "SHLX32rm", 1, "SHLX32rrr", "SHLX32rmr");
  handle_rm("SHLX64rr", "SHLX64rm", 1, "SHLX64rrr", "SHLX64rmr");
  ...
  handle_rm("MULX64rr", "MULX64rm", 2, "MULX64rrr", "MULX64rrm");
